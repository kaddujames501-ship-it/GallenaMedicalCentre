...
export default function Blog(){
  const posts = [
    {t:'Hydration and Heart Health', d:'Why staying hydrated supports cardiovascular function.'},
  ...
  return (
    <section className="py-16">
      <Helmet><title>Blog | Gallena Medical Centre</title></Helmet>
      <div className="container-1120">
        <div className="max-w-3xl mx-auto text-center mb-7"><h1 className="text-3xl font-semibold">Health Tips & News</h1><p className="muted">Latest updates from our clinicians and community.</p></div>
        <div className="grid gap-5 md:grid-cols-3">
          {posts.map(p=> (
            <article key={p.t} className="card">
              ...
              <a className="text-brand-navy font-semibold" href="#">Read more</a>
            </article>
          ))}
        </div>
      </div>
